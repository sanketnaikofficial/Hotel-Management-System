...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>HAMPI INTERNATIONAL HOTEL,</p>
				<p>Station Road Hospet,<br>Karnataka,<br>India.</p>
				<p>(+94) 65 222 44 55</p>
			</address>
			<span><img alt="" src="assets/img/hampi.png"></span>
		</header>
		<article>
			<h1></h1>
			<address >
			...
			<table >
					<tr> 
					    <td>Customer ID : -  <?php echo $id; ?></span></td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@hampiinternational.com || Web :- www.hampiinternational.com || Phone :- +94 65 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
